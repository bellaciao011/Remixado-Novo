...
const LOGISTICS_COPY: Record<SupportedLocale, LogisticsStep[]> = {
  ...
  es: [
    ...
    },
    {
      ...
      body: `<p style="font-size:15px;color:#333;line-height:1.6;">La cuenta regresiva para la FIFA World Cup 2026 continua. Mientras el torneo se acerca, tu coleccion Panini registra cada momento historico.</p>
